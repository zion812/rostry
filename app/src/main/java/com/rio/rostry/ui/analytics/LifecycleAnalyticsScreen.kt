...
import com.rio.rostry.data.model.PerformanceRating
    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                // Pie chart
                PieChart(
                    data = stageDistribution.mapKeys { (key, _) ->
                        try {
                            LifecycleStage.valueOf(key)
                        } catch (e: IllegalArgumentException) {
                            LifecycleStage.EGG // Default fallback
                        }
                    },
                    modifier = Modifier
                        .size(150.dp)
                ...
                Column(
                    ...
                    stageDistribution.entries.forEachIndexed { index, (stage, count) ->
                        LegendItem(
                            label = LifecycleStage.valueOf(stage).displayName,
                            count = count,
